...
<div class="container_12">
<center>
<a href="http://visalus.com/it/vibites/" target="_blank"><img  src="images/vibites_IT_banner.jpg" width="100%"></a>
...
<div class="container_12">
<center>
<a href="http://vi.com/it/products/neon" target="_blank"><img  src="images/NEON_Web_Banner_IT.png" width="100%"></a>
...
<div role="tabpanel">
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#download" aria-controls="download" role="tab" data-toggle="tab">Risorse</a></li>
    <li role="presentation"><a href="#video" aria-controls="video" role="tab" data-toggle="tab">Video</a></li>
    <li role="presentation"><a href="#events" aria-controls="events" role="tab" data-toggle="tab">Eventi</a></li>
    <li role="presentation"><a href="#shareables" aria-controls="shareables" role="tab" data-toggle="tab">Contenuti da condividere</a></li>
    <li role="presentation"><a href="#faqs" aria-controls="faqs" role="tab" data-toggle="tab">FAQ</a></li>
    <li role="presentation"><a href="#2015" aria-controls="2015" role="tab" data-toggle="tab">Nuove iniziative del 2015</a></li>
  ...
  <div class="tab-content">
    ...
    <h3 class="green-text">RISORSE DA SCARICARE:</h3>
                 <h3>MODULI RICHIESTA E ORDINI</h3>
                 <!-- <p><strong>ONLINE REGISTRATION IS AVAILABLE NOW!</strong></p> -->
                  <p><a class="icon-green-doc link-top-padding" href="pdf/1000IT002_promoter_application_r8.pdf" style="display:inline" target="_blank">Modulo di richiesta incaricato</a> (IT) <br/> 
                    <br/>
                    <a class="icon-green-doc link-top-padding" href="pdf/1053IT002_customer_application_r4.pdf" style="display:inline" target="_blank">Modulo di richiesta cliente</a> (IT)
                  <a class="icon-green-doc link-top-padding" href="pdf/2657IT001_self_declaration_r4.pdf" target="_blank">Dichiarazione sostitutiva di
certificazione</a> 
                   <a class="icon-green-doc link-top-padding" href="pdf/PI_IT_SepaMandate_Trans_Final.docx" target="_blank">Mandato di addebito diretto SEPA</a> <br/>
                  <a class="icon-green-doc link-top-padding" href="pdf/2180PIEN001_r1_Payment_Recommendations.pdf" style="display:inline" target="_blank"> Info di pagamento per l'Europa</a> (EN) |  <a class="icon-green-doc link-top-padding" href="pdf/2180PIIT001_r1_Payment_Recomendations.pdf" style="display:inline" target="_blank">Info di pagamento per l'Europa</a> (IT)
      </p>
                  
                  <a data-toggle="collapse" data-target="#payoneer" style="cursor:pointer"> <h3>PAYONEER</h3></a>
  <div id="payoneer" class="collapse">
    Promuoviamo il pagamento di commissioni per le carte Payoneer. Se disponi già di una carta Payoneer, non richiederne una nuova ma fai clic sul link di accesso indicato dalla freccia verde nell'immagine sottostante.<br>
              <p><img class="vi-logo" src="./images/PayoneerExistingAccount.jpg" width="500px"></p><br>
                  
     </div>
                

    <h3>INFORMAZIONI PER GLI INCARICATI</h3> 
<a class="icon-green-doc link-top-padding" href="pdf/1047IT001_IT_Incentives Summary_r6.pdf" style="display:inline">Programma di incentivi - Riepilogo</a></p>

<a class="icon-green-doc link-top-padding" href="pdf/1047IT003_book_incentives_plan_r3.pdf" style="display:inline">Programma di incentivi </a></p>
                     
                             
                            <p><a class="icon-green-doc link-top-padding" href="http://www.visalus.com/sites/default/files/1060IT026_getting_started_training_r8.pdf">Getting Started Training</a> </p>
                            
                           <p><a class="icon-green-doc link-top-padding" href="http://www.vi.com/sites/default/files/slides/IT_CHALLENGE_OVERVIEW_PART1_V3.pptx" style="display:inline">Diapositive di presentazione della Challenge (Parte 1) </a> </p>
                           
                            <p><a class="icon-green-doc link-top-padding" href="http://www.vi.com/sites/default/files/slides/-ITALY%20Strategy%20overview%20slides_23.7.15.pptx" style="display:inline">Slide sulla strategia</a></p>
                            
                            <p><a class="icon-green-doc link-top-padding" href="pdf/EUC780IT001_How_to_Host_Playbook_r3.pdf" target="_blank"> Come organizzare un Challenge Group</a></p>
                            
                             <p><a class="icon-green-doc link-top-padding" href="pdf/1017IT001_bmw_program_guide_r2.pdf" target="_blank"> Linee guida BMW</a></p>
                             
                             <p><a class="icon-green-doc link-top-padding" href="pdf/1605IT003_policies_and_procedures.pdf" target="_blank">Politiche e procedure</a></p> 
...
<span property="media:type" content="application/x-shockwave-flash"></span>	
 ...
 <!-- Modal -->
             ...
             <p>
                  <a class="icon-green-doc" href="pdf/1617IT001_ProductGuide_FINAL.pdf">Guida consolidata a prodotti e kit</a>
                  </p>
                  
                  <p> <a class="icon-green-doc" href="pdf/1239IT001_faq_vi_shape_FINAL.pdf">Vi Shape Kit FAQ </a></p>
    ...
    <h3 class="green-text">EVENTI IN ARRIVO</h3>
...
<p><a href="http://visalus.com/eu/pdf/EU_Events.pdf" target="_blank"><strong>Calendario eventi europei</strong> </a> </p>  
<p><a href="http://visalus.com/eu/pdf/EUC1393IT001_Vitality_flyer_post_r3.pdf" target="_blank"><strong>Volantino Vitality</strong> </a> </p>      
    ...
    <h3 class="green-text">VIDEO DI PRESENTAZIONE</h3>
                  
                  <p class="small-text">[I prodotti, i prezzi e le offerte potrebbero variare a seconda del paese]</p>
                  
<iframe src="video-it.html"  style="width: 940px; height: 360px; margin-bottom: 30px"></iframe>
    ...
    <h3 class="green-text">CONTENUTI DA CONDIVIDERE PIÙ RECENTI</h3>
                   <p>
                   
                   <a style="float:left; margin-right:5px; margin-bottom:5px"  href="images/EUC-675_Shipping_Starts_r2.jpeg" target="_blank"> <img id="my_image" class="sharable" src="images/EUC-675_Shipping_Starts_r2.jpeg"  width="250px" alt="Vi Sweden Sharable" onclick="fbs_click(this)"/></a>
                   
                   <a style="float:left; margin-right:5px; margin-bottom:5px"  href="images/EUC-675_Coming_Soon_Italy_r3.jpg" target="_blank"> <img id="my_image" class="sharable" src="images/EUC-675_Coming_Soon_Italy_r3.jpg"  width="250px" alt="Vi Sweden Sharable" onclick="fbs_click(this)"/></a>
                   
                   <a style="float:left; margin-right:5px; margin-bottom:5px"  href="images/EUC-675_Italy_Coming_r3.jpg" target="_blank"> <img id="my_image" class="sharable" src="images/EUC-675_Italy_Coming_r3.jpg"  width="250px" alt="Vi Sweden Sharable" onclick="fbs_click(this)"/></a>
...
<script>
    ...
    <p style="">
      <a href="pdf/2163IT001_PI_FAQ_r4.pdf" class="green-btn-mdl" target="_blank">SCARICA LE FAQ IN ITALIANO</a>
        </p>	
...
<p>Please note that your application cannot be finalized until all applicable files are submitted to Vi.</p>
 ...
 <!-- End FAQ -->
      ...
      <ul>
         <li> <a href="http://visalus.com/it/equity" target="_blank">Piano capitale netto</a> </li>
      <li> <a href="http://visalus.com/it/challenge-groups" target="_blank">Challenge Group</a> </li>
      <li> <a href="http://visalus.com/it/3-free" target="_blank">3 for free</a> </li>
      <li> <a href="http://visalus.com/it/project-10-kids" target="_blank">Project 10</a> </li>
      <li> <a href="http://visalus.com/it/weekly-bonus-pools-new" target="_blank">Weekly Bonus Pool</a> </li>
...
<footer>
  <div class="container_12">
    <div class="grid_12">
    Per ulteriori informazioni contattare <a href= "mailto:italyinfo@vi.com" style="display:inline">italyinfo@vi.com</a>
        <span class="small-text right">©2015 Vi. Tutti i diritti riservati.</span>
    </div>
  </div>
</footer>
