...
<iframe src="bonusBash.php" width="100%" height="240px" style="overflow: hidden;">
  ...
  <div class="tab-content">
    ...
    <h3 class="green-text">RESOURCES FOR DOWNLOAD:</h3>
                 <h3>APPLICATION & ORDER FORMS</h3>
                  ...
                  <p><a class="icon-green-doc link-top-padding" href="pdf/1000ES001_promoter_application_r17.pdf">Promoter Application</a>
                  <a class="icon-green-doc link-top-padding" href="pdf/1053ES001_customer_application_r5_Final.pdf">Customer Application</a>
      ...
      <p>
        <a class="icon-green-doc link-top-padding" href="pdf/1047ES001_incentives summary_r3_Final.pdf">Incentives Program</a></p>
                         	 <p><a class="icon-green-doc link-top-padding" href="pdf/1089ES001_getting_started_training_r3_Final.pdf">Getting Started Training</a>
...
<span property="media:type" content="application/x-shockwave-flash"></span>	
 ...
 <!-- Modal -->
                  ...
                  <p>
                  <a class="icon-green-doc" href="pdf/Vi_ES Product Guide_r4_Final.pdf">Consolidated Kit & Product Guide</a>
                  </p>
    ...
    <h3 class="green-text">UPCOMING EVENTS</h3>
            ...
            <li><strong>Group Challenge Party in Valencia, Spain </strong> <br>
          Wednesday 3rd December<br>
          Hosted by: Global Ambassador Jason O'Toole & 1-Star Ambassador Steve Mitchell <br>
			Time: 20:00 Shakes served<br>
			Location: Hotel Conqueridor - Valencia, Cervantes, 9, Extramurs</li>  
            <li><strong>Group Challenge Party in Barcelona, Spain </strong> <br>
          Thursday 4th December<br>
          Hosted by: Global Ambassador Jason O'Toole & 1-Star Ambassador Steve Mitchell<br>
			Time: 20:00 Shakes served<br>
			Location: HOTEL CATALONIA PLAÇA CATALUNYA, Bergara, 11, 08002</li>    
...
<section style="background-color:#000; padding: 0px 0;">
<div class="container_12">
<center>
<a href="http://vi.com/eu-es/leadership-launch" target="_blank"><img  src="images/leadershiplaunch-banner.jpg" width="100%"></a>
