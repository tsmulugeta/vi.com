...
<h1>RESOURCES FOR DOWNLOAD:</h1>
                  ...
                  <p><a target="_blank" class="icon-green-doc link-top-padding" href="pdf/1000SE001_promoter_application_r11_Final.pdf">Promoter Application</a>
                  <a target="_blank" class="icon-green-doc link-top-padding" href="pdf/1053ES001_customer_application_r5_Final.pdf">Customer Application</a>
      ...
      <p>
        <a class="icon-green-doc link-top-padding" href="pdf/1047SE001_book_incentives_plan_r3.pdf">Incentives Program</a></p>
                         	 <p><a class="icon-green-doc link-top-padding" href="pdf/1089SE001_getting_started_training_r2_Final.pdf">Getting Started Training</a></p>
           	    <p><a class="icon-green-doc link-top-padding" href="http://visalus.com/pdf/nl/1604UK002_brochure_challenge_mini.pdf">Challenge Brochure</a></p>
...
<span property="media:type" content="application/x-shockwave-flash"></span>	
 ...
 <!-- Modal -->
      ...
      <ul>
        <li><strong>Group Challenge Party with Mike Craig</strong> <br>
          9th November 2014, Stockholm <br>
			<em>Time and Location TBC</em></li>
        </ul>
                  
                   <h3>LATEST SHAREABLES</h3>
                  <p>
                 <a style="float:left; margin-right:20px" href="images/sweden-sharable.jpg" target="_blank"> <img class="sharable" src="images/sweden-sharable.jpg"  width="250px" alt="Vi Sweden Sharable"></a>
                 
               
               <a style="float:left; margin-right:20px" href="images/se/Adele Kamel.jpg" target="_blank"> <img class="sharable" src="images/se/Adele Kamel.jpg"  width="250px" alt="Vi Sweden Sharable"></a>
                 
                 
                 
                 <a style="float:left; margin-right:20px" href="images/se/Rickard Nilsson.jpg" target="_blank"> <img class="sharable" src="images/se/Rickard Nilsson.jpg"  width="250px" alt="Vi Sweden Sharable"></a>
                 
               
               
               
               <a style="float:left; margin-right:20px" href="images/69C06470-980B-4285-95DA-0B47237555E2.png" target="_blank"> <img class="sharable" src="images/69C06470-980B-4285-95DA-0B47237555E2.png"  width="250px" alt="Vi Sweden Sharable"></a>
