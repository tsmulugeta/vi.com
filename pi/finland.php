...
<div class="container_12">
<center>
<a href="http://vi.com/fi/products/neon" target="_blank"><img  src="images/NEON_Web_Banner_FI.png" width="100%"></a>
...
<section id="downloads" style="background-color:#f7f7f7">
	<div class="container_12">
    <div class="grid_12">
...
<div role="tabpanel">
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#download" aria-controls="download" role="tab" data-toggle="tab">Materiaalit</a></li>
    <li role="presentation"><a href="#video" aria-controls="video" role="tab" data-toggle="tab">Videot</a></li>
    <li role="presentation"><a href="#events" aria-controls="events" role="tab" data-toggle="tab">Tapahtumat</a></li>
    <li role="presentation"><a href="#shareables" aria-controls="shareables" role="tab" data-toggle="tab">Jaettavat materiaalit</a></li>
    <li role="presentation"><a href="#faqs" aria-controls="faqs" role="tab" data-toggle="tab">USEIN KYSYTYT KYSYMYKSET</a></li>
    <li role="presentation"><a href="#2015" aria-controls="2015" role="tab" data-toggle="tab">Vuoden 2015 uudet kannustimet</a></li>
  ...
  <div class="tab-content">
    ...
    <h3 class="green-text">LADATTAVAT MATERIAALIT:</h3>
                  <h3>HAKEMUKSET JA TILAUSLOMAKKEET</h3>
                  
                  <p><a target="_blank" class="icon-green-doc link-top-padding" href="pdf/fi/1000FI001_promoter_application_r30.pdf">Promoottorihakemus</a>
                  <a target="_blank" class="icon-green-doc link-top-padding" href="pdf/fi/1053FI001_customer_application_r17.pdf">Asiakashakemus</a>
                  <a class="icon-green-doc link-top-padding" href="pdf/PI_FI_SEPAMANDATE_FINAL.docx">SEPA-suoraveloitusvaltuutus</a> <br/>
                  <a class="icon-green-doc link-top-padding" href="pdf/2180PIEN001_r1_Payment_Recommendations.pdf" style="display:inline">EU-maksutiedot</a> (EN) |  <a class="icon-green-doc link-top-padding" href="pdf/2180PIFI001_r1_Payment_Recommendations.pdf" style="display:inline">EU-maksutiedot</a> (FI)
                  </p>
                  <p><strong>VOIT REKISTERÖITYÄ NYT VERKOSSA!</strong></p>
                  
                  <a data-toggle="collapse" data-target="#payoneer" style="cursor:pointer"> <h3>PAYONEER</h3></a>
  <div id="payoneer" class="collapse">
    Tarjoamme mahdollisuuden palkkioiden maksuun Payoneer-korteille. Jos sinulla on jo Payoneer-kortti, ethän tilaa uutta korttia, vaan klikkaa sen sijaan sisäänkirjautumislinkkiä, joka on merkitty alla olevaan kuvaan vihreällä nuolella.<br>
              <p><img class="vi-logo" src="./images/PayoneerExistingAccount.jpg" width="500px"></p><br>  
       </div>           
      

                  <h3>TIETOA PROMOOTTOREILLE</h3>
                 <!-- <p>
      ...
      <p>
                    <a class="icon-green-doc link-top-padding" href="pdf/1047FI003_book_incentives_plan_r2.pdf">Kannustinohjelma</a></p>
                         	 <p><a class="icon-green-doc link-top-padding" href="pdf/1060FI026_getting_started_training_r7.pdf">Getting Started Training</a>
                             <p><a class="icon-green-doc link-top-padding" href="http://www.vi.com/sites/default/files/slides/FI_CHALLENGEOVERVIEW.PART1.JulyLaunch.V2.FINAL%20Finland%20VERSION%20(1).pptx" target="_blank" style="display:inline"> Yleiskatsaus Challenge-haasteeseen, osa 1</a>
                             <p><a class="icon-green-doc link-top-padding" href="http://www.vi.com/sites/default/files/slides/FI.StrategyOverview.2015_23.7.15.pptx" target="_blank" style="display:inline"> Strategiakatsaus</a><!-- <a class="icon-green-doc link-top-padding" href="#">SELL SHEETS: Promoter Systems & Challenge Kits</a> -->
                  
               

<!-- Modal --></p>

<p><a class="icon-green-doc link-top-padding" href="pdf/EUC783FI001_How_to_Host_Playbook_r2.pdf" target="_blank"> Challenge Group -ryhmän vetäminen</a></p>

<p><a class="icon-green-doc link-top-padding" href="pdf/1088FI001_BMWGuidelines_r3_Final.pdf" target="_blank">BMW-bonuksen ohjeet</a>

<p><a class="icon-green-doc link-top-padding" href="pdf/1605FI002_policies_procedures_book.pdf" target="_blank">Käytännöt ja menettelytavat</a></p>
...
<span property="media:type" content="application/x-shockwave-flash"></span>	
 ...
 <!-- Modal -->
                  ...
                  <!-- Modal -->
                  <h3>TIETOA TUOTTEISTA</h3>
                  <p>
                <a class="icon-green-doc" href="pdf/1617FI001_product_guide_r5_Final.pdf">Yhdistelmäpakkaus ja tuoteopas</a></p>
              
              <p>  <a class="icon-green-doc" href="http://visalus.com/fi/vibites" target="_blank">Vi Bites </a> </p>
              
              <p>  <a class="icon-green-doc" href="pdf/1286FI002_FAQ_ViBites_FINAL4Launch.pdf">Vi Bites: Usein kysytyt kysymykset</a> </p>
                <p>  <a class="icon-green-doc" href="pdf/1285FI002_factsheet_vibites_FINAL_4Launch.pdf">Vi Bites: Tietoa tuotteesta
</a></p>
    ...
    <h3 class="green-text">TULEVAT TAPAHTUMAT</h3>
                 <!-- <ul>
...
<p><a href="http://visalus.com/eu/pdf/EU_Events.pdf" target="_blank"><strong>Euroopan tapahtumakalenteri</strong> </a> </p>  
<p><a href="http://visalus.com/eu/pdf/EUC1402FI001_Vitality_flyer_post_r2.pdf" target="_blank"><strong>Vitality-esite</strong> </a> </p> 
    ...
    <h3 class="green-text">ESITTELYVIDEO</h3>
                  
                  <p class="small-text">[Tuotteet, hinnat ja tarjoukset voivat vaihdella maittain]</p>
...
<iframe src="video-fi.html"  style="width: 940px; height: 360px; margin-bottom: 30px"></iframe>
    ...
    <h3 class="green-text">VIIMEISIMMÄT JAETTAVAT MATERIAALIT</h3>
                  <p>
...
<script>
    ...
    <!-- End Shareables -->
      ...
      <h3 class="green-text">USEIN KYSYTYT KYSYMYKSET</h3>
      
      <p class="small-text2"><a class="green-btn-mdl" style="display:inline" href="http://visalus.com/pi/pdf/Finland-2163FI001_PI_FAQ_r1.pdf" target="_blank">LATAA USEIN KYSYTYT KYSYMYKSET SUOMEKSI</a></p>
...
monthly schedule globally.
   ...
   <a class="icon-green-doc link-top-padding" href="pdf/2180PIEN001_r1_Payment_Recommendations.pdf" style="display:inline">EU-maksutiedot</a> (EN) |  <a class="icon-green-doc link-top-padding" href="pdf/2180PIFI001_r1_Payment_Recommendations.pdf" style="display:inline">EU-maksutiedot</a> (FI)
      ...
      <ul>
      <li> <a href="http://visalus.com/fi/equity" target="_blank">Equity Incentive Plan -kannustinohjelma</a> </li>
      <li> <a href="http://visalus.com/fi/challenge-groups" target="_blank">Challenge Group -ryhmät</a> </li>
      ...
      <li> <a href="http://visalus.com/fi/weekly-bonus-pools-new" target="_blank">Weekly Bonus Pool -viikkopotit</a> </li>
      <li> <a href="http://visalushub.com/" target="_blank">Vi Hub</a> </li>
       <li> <a href="http://visalus.com/fi/2015" target="_blank">Yleiskatsaus vuoteen 2015</a> </li>
...
<footer>
  <div class="container_12">
    <div class="grid_12">
    Saadaksesi lisätietoja ota meihin yhteyttä: <a href= "mailto:finlandinfo@vi.com" style="display:inline">finlandinfo@vi.com</a>
        <span class="small-text right">©2015 Vi. Kaikki oikeudet pidätetään.</span>
    </div>
  </div>
</footer>
