// director standings
    $.ajax({
            ...
            success: function (data) {
                ...
                var output="<table class='standings-table' width='100%'><tr class='head'><td>Name</td><td>Location</td></tr>";
        for (var i in obj) {
  ...
  // amb standings
    ...
    $.ajax({
            ...
            success: function (data) {
                ...
                //alert(result);
                var obj = jQuery.parseJSON(result);
                var output="<table class='standings-table' width='100%'><tr class='head'><td>Rank</td><td>Name</td><td>Points</td><td>Met Minimum</td></tr>";
        for (var i in obj) {
