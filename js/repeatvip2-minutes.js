 // nstparty standings 2star
    ...
    $.ajax({
        ...
        var myDate = new Date(obj[i].QualifiedDate);
            ...
            output+="<tr><td align='center'>" + obj[i].Rank + "</td><td align='center'>" + "<img src='http://visalus.com/sites/default/files/promotions/icon/" + obj[i].MainCountry + ".jpg'>" + "</td><td>" + obj[i].Name + "</td><td>" + obj[i].Location + "</td><td align='center'>" + myDate.getMonth() + "-" + myDate.getDay() + "-" + "2013" + "&nbsp;&nbsp;" + myDate.getHours() + ":" + (myDate.getMinutes()<10?'0':'') + myDate.getMinutes() +"</td></tr>";
        }
