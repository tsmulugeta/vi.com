 // nstparty standings 2star
    ...
    $.ajax({
            ...
            success: function (data) {
                ...
                var output="<table cellspacing='5' cellpadding='5' class='standings-table' width='100%'><tr class='head'><td>Rank</td><td align='center'>Country</td><td>Name</td><td>City/State</td><td align='center'>Points</td></tr>";
        for (var i in obj) {
