    ...
    //updated
       ...
       $.ajax({
            async: false,
            url: "http://api.visalus.com/ITReporting/SalesAnalytics/GetDataBySP/?SPName=usp_Promo_Ambassador_Influencer_byPersonallyEnrolledPromoters_JSONP&?",
            type: 'GET',
            dataType: 'jsonp',
    ...
    $.ajax({
        ...
        output+="</table>";
                ...
                document.getElementById("influencertwo").innerHTML = output;
