    ...
    $.ajax({
            ...
            success: function (data) {
                ...
                var output="<table class='standings-table' width='100%'><tr class='head'><td>Rang</td><td>Nom</td><td>Points derrière le meneur</td><td>Tendance*</td><td>Total Points</td></tr>";
        for (var i in obj) {
        ...
        output+="</table><small>*La tendance est basée sur la différence entre le rang du jour précédent et actuel.</small>";
