    ...
    $.ajax({
            ...
            success: function (data) {
                ...
                var output= "<div class='grid-10 alpha'></div><div class='grid-2 omega'><!--<strong>Total Qualified: " +obj[0].TotalQualified + "</strong>--></div><div class='grid-12 alpha omega'><table class='standings-table' cellpadding='5' width='100%'><tr class='head'><td align='center'>Rank</td><td>Name</td><td align='center'>Points Behind Leader</td><td align='center'>Trending*</td><td align='center'>Total Points</td><td align='center'>Met Minimum</td><td align='center'>Country</td></tr>";
        for (var i in obj) {
            output+="<tr><td align='center'>" + obj[i].Rank +  "</td><td>" + obj[i].FirstName + "&nbsp;" + obj[i].LastName + "</td><td align='center'>" + obj[i].PointsBehindLeader + "</td><td align='center'><div class='" + obj[i].Trending + "'></div></td><td align='center'>"  + obj[i].TotalPoints + "</td><td align='center'><img src='/sites/default/files/promotions/icon/" + obj[i].MetPoints + ".png'></td><td align='center'><img src='/sites/default/files/promotions/icon/" + obj[i].Country + ".jpg'></td></tr>";
        }
