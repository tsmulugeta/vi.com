...
//document.write((myDate.getMonth() + 1) + "/" + myDate.getDate() + "/" + myDate.getFullYear());
    ...
    $.ajax({
        ...
        var ampm = hours >= 12 ? 'p.m.' : 'a.m.';
            output= "<p>Updated: "+ myDate.getHours() + ":" + (myDate.getMinutes()<10?'0':'') + myDate.getMinutes() + "&nbsp;" +ampm +"</p>";
        }
 ...
 //  output= "<p>Updated: "+ myDate.getdate() + ":" + (myDate.getMinutes()<10?'0':'') + myDate.getMinutes() + "&nbsp;" +ampm +"</p>";