// director standings
    ...
    $.ajax({
            ...
            success: function (data) {
                ...
                var output="<table width='100%' class='standings-table'><tr class='header'><td>Nom</td><td>Emplacement</td></tr>";
        for (var i in obj) {
  ...
  // amb standings
    ...
    $.ajax({
            ...
            success: function (data) {
                ...
                //alert(result);
                var obj = jQuery.parseJSON(result);
                var output="<table width='100%' class='standings-table'><tr class='header'><td>Rang</td><td>Nom</td><td>Points</td><td>Minimum atteint</td></tr>";
        for (var i in obj) {
