...
<h1>RESOURCES FOR DOWNLOAD:</h1>
                  ...
                  <p><a target="_blank" class="icon-green-doc link-top-padding" href="pdf/1000SE001_promoter_application_r11.pdf">Promoter Application</a>
                  <a target="_blank" class="icon-green-doc link-top-padding" href="pdf/1053SE001_customer_application_r11.pdf">Customer Application</a>
      ...
      <p>
        <a class="icon-green-doc link-top-padding" href="http://visalus.com/pdf/nl/Vi_Incentives_Programme_Summary_UK.pdf">Incentives Program</a> (PDF)        </p>
                         	 <p><a class="icon-green-doc link-top-padding" href="http://visalus.com/pdf/fi/Vi_NL GST_ENG_FINAL_v3_AM.pdf">Getting Started Training</a> (PDF)
                </p>
           	    <p><a class="icon-green-doc link-top-padding" href="http://visalus.com/pdf/nl/1604UK002_brochure_challenge_mini.pdf">Challenge Brochure</a> (PDF)                 </p>
...
<span property="media:type" content="application/x-shockwave-flash"></span>	
 ...
 <!-- Modal -->
      ...
      <h3>UPCOMING EVENTS</h3>
                  <ul>
                    <li><strong>Group Challenge Party with Aaron Fortner</strong> <br>
                      25th October 2014, Stockholm <br>
                  ...
                  <p>
                 <a href="images/sweden-sharable.jpg" target="_blank"> <img class="sharable" src="images/sweden-sharable.jpg"  width="250px" alt="Vi Sweden Sharable"></a>
                 </p>
