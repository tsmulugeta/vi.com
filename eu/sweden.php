...
<div class="container_12">
<center>
<a href="http://vi.com/se/leadership-launch" target="_blank"><img  src="images/leadershiplaunch-banner.jpg" width="100%"></a>
...
<div role="tabpanel">
  ...
  <div class="tab-content">
    ...
    <h3 class="green-text">RESOURCES FOR DOWNLOAD:</h3>
                  ...
                  <p><a target="_blank" class="icon-green-doc link-top-padding" href="pdf/1000SE001_promoter_application_r15.pdf">Promoter Application</a>
                  <a target="_blank" class="icon-green-doc link-top-padding" href="pdf/1053SE001_customer_application_r11_Final.pdf">Customer Application</a> <br />
                  <a class="icon-green-doc link-top-padding" href="pdf/2180PIEN001_r1_Payment_Recommendations.pdf" style="display:inline">EU Payment Info</a> (EN) |  <a class="icon-green-doc link-top-padding" href="pdf/2180PISE001_r1_Payment_Recommendations.pdf" style="display:inline">EU Payment Info</a> (SE)
      ...
      <p>
        <a class="icon-green-doc link-top-padding" href="pdf/1047SE001_book_incentives_plan_r3.pdf">Incentives Program</a></p>
                         	 <p><a class="icon-green-doc link-top-padding" href="pdf/1089SE001_getting_started_training_r2_Final.pdf">Getting Started Training</a>
...
<span property="media:type" content="application/x-shockwave-flash"></span>	
 ...
 <!-- Modal -->
                  ...
                  <p>
                  <a class="icon-green-doc" href="pdf/1617SE001_product_guide_r5_Final.pdf">Consolidated Kit & Product Guide</a>
                </p>
    ...
    <h3 class="green-text">UPCOMING EVENTS</h3>
      ...
      <!--  <li><strong>Local Success Training </strong> <br>
         Saturday 6th December, Helsingborg <br>
         Hosted by: Founder & Global Ambassador Nick Sarnicola & 5-Star Ambassador Alan Guzzino  <br>
			Time: 15:00 Training begins <em><br>
			</em>Location: Elite Hotel Marina Plaza Kungstorget 6, 251 10 Helsingborg </li>
...
<script src="https://cdnapisec.kaltura.com/p/1011121/sp/101112100/embedIframeJs/uiconf_id/25943622/partner_id/1011121?autoembed=true&amp;playerId=kaltura_player_14091872621&amp;cache_st=1409187262&amp;width=940&amp;height=360&amp;flashvars[streamerType]=auto&amp;flashvars[playlistAPI.kpl0Id]=0_m81n8808" type="text/javascript"></script>
    ...
    <h3 class="green-text">LATEST SHAREABLES</h3>
                  ...
                  <a style="float:left; margin-right:5px; margin-bottom:5px" href="images/Marco_Passanante_2Staramb_.jpg" target="_blank"> <img class="sharable" src="images/Marco_Passanante_2Staramb_.jpg"  width="230px" alt="Vi Sweden Sharable" onclick="fbs_click(this)"/></a>
                  ...
                  <a style="float:left; margin-right:5px; margin-bottom:5px" href="images/Adele Kamel_AMB_r2.jpg" target="_blank"> <img class="sharable" src="images/Adele Kamel_AMB_r2.jpg"  width="230px" alt="Vi Sweden Sharable" onclick="fbs_click(this)"/></a>
               ...
               <a style="float:left; margin-right:5px; margin-bottom:5px" href="images/se/Adele Kamel.jpg" target="_blank"> <img class="sharable" src="images/se/Adele Kamel.jpg"  width="230px" alt="Vi Sweden Sharable" onclick="fbs_click(this)"/></a>
...
<h3>How VI Processes Direct Debit Orders</h3>
 ...
 <ol>
	...
	<li>Order is held until Vi receives payment confirmation from bank  (5-7 days) 
      ...
      <p><a class="green-btn-mdl" style="display:inline" href="http://learn.vi.com/euexpansion/pdf/Sweden-2163SE001_PI_FAQ_r1.pdf" target="_blank">Download the FAQ in Swedish</a></p>
