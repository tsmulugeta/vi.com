...
<section id="downloads" style="background-color:#fff; padding: 60px 0 0px 0;">
	<div class="container_12">
        ...
        <center>
        <a href="http://vi.co.uk" target="_blank"><img class="flags" src="images/uk-flag.jpg" alt="Vi Logo"> </a>
     ...
     <!--   <p style="margin-top:0px">
      <a href="http://vi.co.uk"  class="green-btn-mdl" target="_blank">Learn More</a>
    	...
    	<div class="grid_3">
        <center>
       <a href="http://vi.co.uk/ie" target="_blank"> <img class="flags" src="images/ie-flag.jpg" alt="Vi Logo"> </a>
...
<div id="content-wrapper">
      ...
      <div id="slide1 slide1-nl" class="container_12">
	   ...
	   <p>In the meantime, <a class='iframe' style="display: inline;" href="http://learn.vi.com/euexpansion/webinar-schedule/"><strong>click here</strong></a> to join any of our daily Leader-run webinars! <br>
              ...
              <p><a href="pdf/european-events-april.pdf" target="_blank"><img  src="images/button-blue.gif" ></a> </p>
...
<center>
<h4 style="font-size:20px;">FILMY VI Z OMÓWIENIEM</h4>
</center>
</div>
...
<div style="padding-bottom:10px;"> 
<center>
<h4 style="font-size:20px;">CZĘSTO ZADAWANE PYTANIA DLA KRAJÓW PI</h4>
</center>
</div>
...
<p class="small-text">[ Pobierz często zadawane pytania dla krajów PI:: <a class="linkinline" href="pdf/2163ENG001_PI_FAQ_r3.pdf" target="_blank">ENG</a> | <a class="linkinline" href="pdf/Sweden-2163SE001_PI_FAQ_r1.pdf" target="_blank">SE</a> | <a class="linkinline" href="pdf/Finland-2163FI001_PI_FAQ_r1.pdf" target="_blank">FI</a> | <a class="linkinline" href="pdf/Spain-2163ESESP001_PI_FAQ_r5.pdf" target="_blank">ES</a> ]</p>
