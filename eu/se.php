...
<option selected value="se.php">Sweden</option>
...
<div id="content-wrapper">
      ...
      <div id="slide1 slide1-nl" class="container_12">
        <div class="grid_12" style="margin-top: 30px;">
          ...
          <h3 class="green-text">EXPANSION I EU</h3>

			<p>Vi tar The Challenge till Europa!</p>
		    <p>Vi är mycket glada över den spännande nyheten om vår expansion i Europa! </p>
		    <p>Håll koll på den här sidan för mer information. Uppdateringar kommer endast att publiceras här. </p>
		   <!-- <p>In the meantime, <a class='iframe' style="display: inline;" href="http://learn.vi.com/euexpansion/webinar-schedule/"><strong>click here</strong></a> to join any of our daily Leader-run webinars! <br>
		      (For International Influencer Webinar Schedule For Spain <a class='iframe' style="display: inline;" href="http://learn.vi.com/euexpansion/webinar-schedule/es-webinar-eng.php"><strong>click here</strong></a>) </p> -->
               ...
               <p>Under tiden kan du <a class='iframe' style="display: inline;" href="http://learn.vi.com/euexpansion/webinar-schedule/"><strong>klicka här</strong></a> för att delta i våra dagliga ledarledda webbinarier! <br>
		      (<a class='iframe' style="display: inline;" href="http://learn.vi.com/euexpansion/webinar-schedule/es-webinar-eng.php"><strong>Klicka här </strong></a> för schema över internationella inspirationswebbinarier för Spanien) </p>
              
              <p>
              <a style="font-size: 16px; margin-top: 50px; text-decoration: underline;" href="pdf/International_Influencers_Flyer_rev11-11a.pdf" target="_blank">Klicka här för att ladda ner schemat för internationella inspirationswebbinarier</a>
              </p>
...
<p>NEDERLÄNDERNA</p> 
 <p class="button-margin">
  <a href="http://www.nl.vi.com" target="_blank" class="green-btn-lrg">KLICKA HÄR</a>
  </p>
...
<section id="downloads" style="background-color:#f5f5f5; padding: 60px 0 40px 0;">
	<div class="container_12">
        ...
        <center>
       <a href="http://se.vi.com"> <img class="flags" src="../assets/images/se-sweden-flag.jpg" alt="Vi Logo"> </a>
        <p style="margin-top:0px"><a href="http://se.vi.com" class="green-btn-mdl" target="_blank">Klicka här för Landing Page</a></p>	
    	...
    	<div class="grid_4">
        <center>
       <a href="fi.vi.com"> <img class="flags" src="../assets/images/se-finland-flag.jpg" alt="Vi Logo"> </a>
        
        <p style="margin-top:0px"><a href="http://fi.vi.com" class="green-btn-mdl" target="_blank">Klicka här för Landing Page</a></p>	
        ...
        <center>
        <img class="flags" src="../assets/images/se-spain-flag.jpg" alt="Vi Logo">
...
<center>
<h4 style="font-size:20px;">Informationsvideor om Vi</h4>
</center>
</div>


<ul class="nav nav-tabs" role="tablist" id="myTab">
  <li class="active"><a href="#swedish" role="tab" data-toggle="tab">Svenska</a></li>
  <li ><a href="#english" role="tab" data-toggle="tab">Engelska</a></li>
  <li ><a href="#finnish" role="tab" data-toggle="tab">Finska</a></li>
  <li><a href="#spanish" role="tab" data-toggle="tab">Spanska</a></li>
</ul>

<div class="tab-content">

  <div class="tab-pane active" id="swedish">
...
<ul class="nav nav-tabs" role="tablist" id="myTab2">
  <li class="active"><a href="#english-overview" role="tab" data-toggle="tab">Engelska</a></li>
  <li><a href="#finnish-overview" role="tab" data-toggle="tab">Finska</a></li>
  <li><a href="#spanish-overview" role="tab" data-toggle="tab">Spanska</a></li>
</ul>
...
<br/>
<h4 style="font-size:20px;">Rekommendationer för betalningar inom Europa</h4>
 
<p style="margin-top:10px">Vi vill hjälpa dina nya promotorer och kunder att komma igång med The Challenge så effektivt som möjligt. Vi erbjuder tre olika betalningsalternativ för personer som deltar i The Challenge och beställer Promoter-kit eller Challenge-kit.</p>
 
<h4 style="font-size:20px;">Vi rekommenderar att du anger betalningsalternativen i följande ordning</h4>
<ol> 
<li> <strong>Kortbetalning</strong> – det snabbaste och enklaste sättet att komma igång med The Challenge och börja utmana andra. Produkterna skickas normalt inom 24 timmar.</li>
<li>  <strong>PayPal</strong> – lika snabbt och enkelt som kortbetalning. Använd det här alternativet för kunder som inte har något betalkort eller inte vill använda det. Produkterna skickas normalt inom 24 timmar.</li>
<li>     <strong>Autogiro</strong> –
	<ul> 
    	<li>Det här alternativet bör användas som en sista utväg eftersom det medför att Promoter- och Challenge-kit blir försenade med minst 7–9 dagar.</li>
		<li>Vi skickar produkterna efter att Vi har tagit emot betalningen. På grund av EU:s regler och förordningar för banktjänster dröjer det upp till 7 dagar innan en betalning via autogiro bekräftas.  Om det uppstår problem med autogiro-informationen kan det ta längre tid.</li>
		<li> Av den anledningen skickas produkterna inom 7–9 dagar.  </li>
		<li>Observera att BV inte visas förrän betalningen är mottagen.</li>
		<li>Vi rekommenderar dig att uppmuntra dina kunder att anmäla sig till autoship den femte i månaden för att eventuella problem med autogiro ska kunna lösas före månadsskiftet.</li>
	</ul>
 </li>
 </ol>
 
<h4 style="font-size:20px;"> Hur Vi hanterar autogiro-beställningar</h4>
 
 <ol>
	<li> Vi tar mot en autogiro-beställning.</li>
	<li> Beställningen blir liggande tills Vi får betalningsbekräftelsen från banken (5–7 dagar) 
    	<ol type="a">
			<li>Om det kommer en betalningsbekräftelse skickas produkten </li>
			<li> Om betalningen av någon anledning misslyckas gör vår kundtjänst följande:
            	<ol type="i">
                  <li>Kontot spärras tillfälligt  </li>
                  <li> Ett e-postmeddelande med information om den nekade betalningen skickas till promotorn och den person som rekryterade honom eller henne </li>
                  <li> Därefter ringer någon från vår kundtjänst till promotorn för att informera honom eller henne om att autogirobetalningen har nekats och för att komma överens om en alternativ betalningsmetod</li>
              </ol>
           </li>
       </ol>
    </li>
