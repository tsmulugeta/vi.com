...
<option selected value="es.php">Spanish</option>
</select>
                  </form>
              </div>
...
<div id="content-wrapper">
      ...
      <div id="slide1 slide1-nl" class="container_12">
        <div class="grid_12" style="margin-top: 30px;">
          ...
          <h3 class="green-text">EXPANSIÓN UE</h3>

			<p>¡Vi está trayendo el Reto para Europa! </p>
		    <p>¡Estamos muy contentos de anunciar estas emocionantes noticias construyendo nuestra expansión en Europa!</p>
		    <p>Vuelva a este sitio para obtener más información. Las actualizaciones solo se publicarán aquí. </p>
		    <p>¡Por el momento, <a class='iframe' style="display: inline;" href="http://learn.vi.com/euexpansion/webinar-schedule/es-webinar.php"><strong>haga clic aquí </strong></a> para participar en cualquiera de nuestros webinars diarios presentados por los Líderes!</p>
   
   <p>
   <a style="font-size: 16px; text-decoration: underline;" href="pdf/International_Influencers_Flyer_rev11-11a.pdf" target="_blank">Haga clic aquí para descargar el Horario Internacional del Influenciador</a>  
   </p>
...
<p>HOLANDA</p> 
 <p class="button-margin">
  <a href="http://www.nl.vi.com" target="_blank" class="green-btn-lrg">HAGA CLICK AQUÍ</a>
  </p>
...
<section id="downloads" style="background-color:#f5f5f5; padding: 60px 0 40px 0;">
	<div class="container_12">
        ...
        <center>
       <a href="http://se.vi.com"> <img class="flags" src="../assets/images/es-sweden-flag.jpg" alt="Vi Logo"> </a>
        
        <p style="margin-top:0px"><a href="http://se.vi.com" class="green-btn-mdl" target="_blank">clic aquí para Landing Page</a></p>	
    	...
    	<div class="grid_4">
        <center>
       <a href="http://fi.vi.com"> <img class="flags" src="../assets/images/es-finland-flag.jpg" alt="Vi Logo"> </a>
        
        <p style="margin-top:0px"><a href="http://fi.vi.com" class="green-btn-mdl" target="_blank">clic aquí para Landing Page</a> </p>
        ...
        <center>
        <img class="flags" src="../assets/images/es-spain-flag.jpg" alt="Vi Logo">
...
<center>
<h4 style="font-size:20px;">PREGUNTAS FRECUENTES PARA PAÍSES PI</h4>
</center>
</div>


<ul class="nav nav-tabs" role="tablist" id="myTab">
	<li class="active"><a href="#spanish" role="tab" data-toggle="tab">Spanish</a></li>
  <li><a href="#english" role="tab" data-toggle="tab">English</a></li>
...
permite PI cuando está basada en Clientes.
      </div>
    </div>
  </div>
  <div class="panel panel-default">
...
están disponibles en alemán.
  ...
  <tr class="head">
    ...
    <th align="center" valign="middle" scope="col" style="text-align: center;">Mercado PI (por ejemplo, Suecia)</th>
...
usted puede registrarse para obtener una Tarjeta Prosperity prepago cargada en Euros (al hacer compras, tasas y transacciones de divisas pueden
...
<br/>
<h4 style="font-size:20px;">Recomendaciones de Pago Europeas</h4>
 
<p style="margin-top:10px">VI quiere apoyar sus nuevos Promotores y Clientes a juntarse al Challenge de la manera más eficaz posible. Vi ofrece tres diferentes opciones de pago para que se una al Challenge y pida Promoter kits o Challenge kits.</p>
 
<h4 style="font-size:20px;">Recomendamos que el pago sea solicitado en la siguiente orden
</h4>
<ol> 
<li> <strong> Tarjeta de Crédito</strong> – Esta es la forma más rápida y fácil para conseguir participar en el Challenge y empezar a retar a otros. Normalmente, los productos son enviados dentro de 24 horas.</li>
...
<li>     <strong>Débito Directo</strong> –
	<ul> 
    	<li>Use esto como una última opción ya que el envío de los Promoter y Challenge kits demorará un mínimo de 7-9 días.</li>
		<li>Vi envía los productos después de recibir el pago. Debido a las normas y reglamentos bancarios de la UE hay un retraso en la confirmación del pago de Débito Directo de hasta 7 días. Si hay problemas con la información del Débito Directa  esto puede tomar más tiempo.</li>
		<li> Por esta razón los productos son enviados dentro de 7-9 días. </li>
		<li>Tenga en cuenta que el BV no se mostrará hasta que se reciba el pago.</li>
		<li>Recomendamos que usted aconseje a sus potenciales clientes a inscribirse para el Auto-envío en el día 5 del mes para asegurar que cualquier problema con el Débito Directo sea resuelto antes del fin de mes.</li>
	</ul>
 </li>
 </ol>
 
<h4 style="font-size:20px;">  Cómo VI Procesa Pedidos Débito Directo</h4>
 
 <ol>
	<li> Vi recibe un pedido de Débito Directo.</li>
	<li>El Pedido es retenido hasta que Vi reciba la confirmación del pago del banco (5-7 días)
    	<ol type="a">
			<li>Si la confirmación del pago es reciba entonces el producto es enviado </li>
			<li>Si el pago falla por alguna razón nuestro Call Center hace lo siguiente:
            	<ol type="i">
                  <li> La cuenta se coloca en una retención temporal </li>
                  <li>Un correo electrónico es enviado al Promotor y su reclutador informando del rechace</li>
                  <li>Nuestro equipo del Call Center llamará entonces al Promotor para informarles de que el Débito Directo fue rechazado y para pedir métodos alternativos de pago</li>
              </ol>
           </li>
       </ol>
    </li>
