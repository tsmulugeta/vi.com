...
<div id="header-bonus-bash">
<div class="container_12">
    	<a href="http://www.visalus.com/fi/bonus-bash" target="_blank"><img src="images/CS-2335_holiday_bash_banner_r2-fi.jpg" alt="Vi Logo" width="100%"> </a>
  </div>
 </div>
...
<div role="tabpanel">
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#download" aria-controls="download" role="tab" data-toggle="tab">Downloads</a></li>
    <li role="presentation"><a href="#events" aria-controls="events" role="tab" data-toggle="tab">Events</a></li>
    <li role="presentation"><a href="#video" aria-controls="video" role="tab" data-toggle="tab">Overview Video</a></li>
    <li role="presentation"><a href="#shareables" aria-controls="shareables" role="tab" data-toggle="tab">Shareables</a></li>
    <li role="presentation"><a href="#payment" aria-controls="payment" role="tab" data-toggle="tab">European Payment
  ...
  <div class="tab-content">
    ...
    <h3 class="green-text">RESOURCES FOR DOWNLOAD:</h3>
                  ...
                  <p><a target="_blank" class="icon-green-doc link-top-padding" href="pdf/1000FI001_promoter_application_r8_Final.pdf">Promoter Application</a>
                  <a target="_blank" class="icon-green-doc link-top-padding" href="pdf/1053FI001_customer_application_r6_Final.pdf">Customer Application</a>
                  <a class="icon-green-doc link-top-padding" href="pdf/PI_FI_SEPAMANDATE_FINAL.docx">SEPA Direct Debit Mandate</a>
                  </p>
      ...
      <p>
                    <a class="icon-green-doc link-top-padding" href="pdf/1047FI001_book_incentives_plan_r2.pdf">Incentives Program</a></p>
                         	 <p><a class="icon-green-doc link-top-padding" href="pdf/1089FI001_getting_started_training_r2_Final.pdf">Getting Started Training</a>
...
<span property="media:type" content="application/x-shockwave-flash"></span>	
 ...
 <!-- Modal -->
    ...
    <h3 class="green-text">UPCOMING EVENTS</h3>
                     <ul>
                     <li><strong>Group Challenge Party with Nick Sarnicola</strong> <br>
18th November 2014, Helsinki <br>
Time: 19:00hrs Shakes<em><br>
</em>Location: Soko hotel Vantaa Hertaksentie 2 Vantaa 
                     </ul> </li>
...
<script src="https://cdnapisec.kaltura.com/p/1011121/sp/101112100/embedIframeJs/uiconf_id/25943622/partner_id/1011121?autoembed=true&amp;playerId=kaltura_player_14091872621&amp;cache_st=1409187262&amp;width=940&amp;height=360&amp;flashvars[streamerType]=auto&amp;flashvars[playlistAPI.kpl0Id]=0_68tgn85q" type="text/javascript"></script>
    ...
    <h3 class="green-text">LATEST SHAREABLES</h3>
                  <p>
                    ...
                    <a style="float:left; margin-right:5px; margin-bottom:5px" href="images/Toni Kontiomaa_FI_ND.jpeg" target="_blank"> <img class="sharable" src="images/Toni Kontiomaa_FI_ND.jpeg"  width="230px" alt="Vi Sweden Sharable"></a>
                   
                    <a style="float:left; margin-right:5px; margin-bottom:5px" href="images/Mervi Hämäläinen_r2.jpg" target="_blank"> <img class="sharable" src="images/Mervi Hämäläinen_r2.jpg"  width="230px" alt="Vi Sweden Sharable"></a>
                    
                    <a style="float:left; margin-right:5px; margin-bottom:5px" href="images/Heidi Heikkinen.jpg" target="_blank"> <img class="sharable" src="images/Heidi Heikkinen.jpg"  width="230px" alt="Vi Sweden Sharable"></a>
                    
                    <a style="float:left; margin-right:5px; margin-bottom:5px" href="images/Juha Laakkonen_RD_FI.jpg" target="_blank"> <img class="sharable" src="images/Juha Laakkonen_RD_FI.jpg"  width="230px" alt="Vi Sweden Sharable"></a>
                     
                    <a style="float:left; margin-right:5px; margin-bottom:5px" href="images/Erkki Pohjola_RD_FI.jpg" target="_blank"> <img class="sharable" src="images/Erkki Pohjola_RD_FI.jpg"  width="230px" alt="Vi Sweden Sharable"></a>
                     
                    <a style="float:left; margin-right:5px; margin-bottom:5px" href="images/finland-sharable.jpg" target="_blank"> <img class="sharable" src="images/finland-sharable.jpg"  width="230px" alt="Vi Sweden Sharable"></a>
                     
                    <a style="float:left; margin-right:5px; margin-bottom:5px" href="images/fi/7583_892392540772724_6130538568239721317_n.jpg" target="_blank"> <img class="sharable" src="images/fi/7583_892392540772724_6130538568239721317_n.jpg"  width="230px" alt="Vi Sweden Sharable"></a>
                 
                 <a style="float:left; margin-right:5px; margin-bottom:5px" href="images/fi/Jorma_RD_FI_r2.jpg" target="_blank"> <img class="sharable" src="images/fi/Jorma_RD_FI_r2.jpg"  width="230px" alt="Vi Sweden Sharable"></a>
                 
                 <a style="float:left; margin-right:5px; margin-bottom:5px" href="images/fi/Matti_RD_FI_r2.jpg" target="_blank"> <img class="sharable" src="images/fi/Matti_RD_FI_r2.jpg"  width="230px" alt="Vi Sweden Sharable"></a>
                 
                 <a style="float:left; margin-right:5px; margin-bottom:5px" href="images/fi/Mervi_RD_FI_r2.jpg" target="_blank"> <img class="sharable" src="images/fi/Mervi_RD_FI_r2.jpg"  width="230px" alt="Vi Sweden Sharable"></a>
                 
                 <a style="float:left; margin-right:5px; margin-bottom:5px" href="images/fi/Toni_RD_FI_r2.jpg" target="_blank"> <img class="sharable" src="images/fi/Toni_RD_FI_r2.jpg"  width="230px" alt="Vi Sweden Sharable"></a>
                 
                 
                 <a style="float:left; margin-right:5px; margin-bottom:5px" href="images/54BA5CC8-1D51-41B1-BC7C-A9C29A04C7A3.png" target="_blank"> <img class="sharable" src="images/54BA5CC8-1D51-41B1-BC7C-A9C29A04C7A3.png"  width="230px" alt="Vi Sweden Sharable"></a>
...
<h3>How VI Processes Direct Debit Orders</h3>
 ...
 <ol>
	...
	<li>Order is held until Vi receives payment confirmation from bank  (5-7 days) 
      ...
      <p class="small-text">[<a style="display:inline" href="http://learn.vi.com/euexpansion/pdf/Finland-2163FI001_PI_FAQ_r1.pdf" target="_blank">Download the FAQ in Finnish</a>]</p>
